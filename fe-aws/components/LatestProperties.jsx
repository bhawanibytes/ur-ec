...
export default function LatestProperties() {
  const { getLatestProperties, loading, error } = useProperties();
  const properties = getLatestProperties(50);
      ...
      <div className="container px-3 px-md-0">
        <div className="text-center mb-4 mb-md-5">
          ...
          <p className="text-muted">
            Discover latest properties handpicked for luxury living and
